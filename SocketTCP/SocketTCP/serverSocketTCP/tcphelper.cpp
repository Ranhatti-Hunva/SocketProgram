...
//                std::cout << "=> MSG_incomplete:" << host_msg->msg_incompleted << std::endl;
//                std::cout << "   ID msg: "<< (int) host_msg->ID_msg_incompleted << std::endl;
//                std::cout << "   Buffer:" << recv_buffer << std::endl;
//                std::cout << "   Length of buffer:" <<  status << std::endl;
//                std::cout << "   Result of unpacked:" << is_msg_usable << std::endl << std::endl;
