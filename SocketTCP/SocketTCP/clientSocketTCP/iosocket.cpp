...
void splits_string(const std::string& subject, std::vector<std::string>& container, const char* seperator)
{
    container.clear();
    ...
    for (char *p = strtok(s, seperator); p != nullptr; p = strtok(nullptr, seperator))
    {
